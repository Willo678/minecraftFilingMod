...
public class EditBox extends AbstractWidget implements Widget, GuiEventListener {
    ...
    /** Current index of the text cursor */
    protected int cursorPos;
    /** Index used to for highlighting text (same as {@link #cursorPos} when not highlighting) */
    ...
    protected void deleteText(int pCount) {
     ...
     */
    protected int getWordPosition(int pN, int pPos) {
     ...
     */
    protected int getWordPosition(int pN, int pPos, boolean pSkipWs) {
        int i = pPos;
        boolean flag = pN < 0;
        int j = Math.abs(pN);
    ...
    protected int getCursorPos(int pDelta) {
